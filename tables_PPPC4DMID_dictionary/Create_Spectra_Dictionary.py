...
def Spectra_Reader_NoEW():
    ...
    PyDict =    {'x':X ,'Masses':masses , 'Particle_Spectra':spectra_types, 'DM_Channels':['ee', 'mumu', 'tautau', 'qq', 'bb', 'tt', 'ZZ', 'WW', 'hh', 'gammagamma','gg']}
    PyDict_ew = {'x':X ,'Masses':masses , 'Particle_Spectra':spectra_types, 'DM_Channels':['ee', 'mumu', 'tautau', 'qq', 'bb', 'tt', 'ZZ', 'WW', 'hh', 'gammagamma','gg']}

    for spec in spectra_types:
        print 'Reading the specra for the particle : ' , spec
        PyDict[spec]    = {}
        PyDict_ew[spec] = {}
        ...
        for mdm in masses:
            ...
            dic = { 'ee':[] ,'mumu':[] , 'tautau':[], 'qq':[], 'bb' : [] , 'tt':[], 'ZZ':[] , 'WW':[] , 'hh':[] , 'gammagamma':[] ,'gg':[] }
            for L in X:
        ...
        for mdm in masses:
            #print ' I am reading the mass: \n' , str(mdm)
            dic_ew = { 'ee':[] ,'mumu':[] , 'tautau':[], 'qq':[], 'bb' : [] , 'tt':[], 'ZZ':[] , 'WW':[] , 'hh':[] , 'gammagamma':[] ,'gg':[] }
...
#Tables = np.load('PPPC_Tables_EW.npy').item()    # Load the Dictionary from the npy file
'''
# print
...
print 'Available DM annihilation channels:\t'     , Tables['DM_Channels']      , '\n'  #['ee', 'mumu', 'tautau', 'qq', 'bb', 'tt', 'ZZ', 'WW', 'hh', 'gammagamma', 'gg']

spectrum , mass , channel = 'gammas', '5.0', 'ee'
